    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 border-b px-4 py-2 ">
            <div className="flex gap-4">
                ...
                <textarea  value={inputValue} onChange={(e)=> setInputValue(e.target.value)} ref={inputRef}  className=" flex-grow resize-none p-4 overflow-hidden text-lg outline-none" placeholder="What's happenin" />
            </div>
            <Button type="submit" className=" self-end" gray={false}> Tweet</Button>
        </form>
)}